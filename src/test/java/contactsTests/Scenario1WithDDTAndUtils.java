...
public class Scenario1WithDDTAndUtils {
	...
	@Test(dataProvider = "getdata",dataProviderClass = ExcelFileUtility.class)
	public void create(String sheetName) throws EncryptedDocumentException, IOException, InterruptedException {
	...
	//	sheetName=eUtil.getdata("Contacts");
